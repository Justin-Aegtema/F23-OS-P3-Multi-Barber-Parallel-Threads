...
// worked on details including adding many of the semaphors which make the values reach the correct values
...
int addNewArrivalQueue(struct student *s)
{
	...
	// Return value:
		// 0 -> waiting queue is full
		// 1 -> student added to queue
